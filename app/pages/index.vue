...
<template>
  <div>
    ...
    <section class="bg-gradient-to-b from-white to-amber-50">
      ...
      <!-- Who Cottage Bowls Is For (moved up under hero/banner) -->
        ...
        <UContainer class="space-y-16">
          ...
          <section class="grid gap-10 lg:grid-cols-2 items-start">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
              <img
                src="/images/cottagevsfroyo.png"
                alt="Cottage Bowls compared to frozen yogurt"
                class="w-full h-40 sm:h-48 rounded-xl object-cover shadow-md border border-amber-200"
              >
              <img
                src="/images/cottagevsacai.png"
                alt="Cottage Bowls compared to acai bowls"
                class="w-full h-40 sm:h-48 rounded-xl object-cover shadow-md border border-amber-200"
              >
            </div>
          </section>
